            ...
            <form className="text-start mt-3" id="publicationForm">
                ...
                <div className='row'>
                    <div className='col'>
                        ...
                        <textarea className="form-control" name="recommendation" id="recommendation" type="text" onChange={handleChange} ></textarea>
                    ...
                    <div className='col'>
                        ...
                        <textarea className="form-control" name="summary" id="summary" type="text" onChange={handleChange} ></textarea>
